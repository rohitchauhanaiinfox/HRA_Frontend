...
const EditEmployee = () => {
    ...
    const getEmployee = async () => {
        setLoading(true);
        try {
            const res = await apiGet(`users/emps/${employeeId}/get`);
            if (res.data.status === true) {
                ...
                setDob(employee.profile?.dob ? new Date(employee.profile.dob) : "");
                setUserStatus(employee.status === "active" ? "Active" : "Inactive");
                setReportingManager(employee.reporting_manager || 1);
                setPermission(employee.permission || "");
                setJobRole(employee.job_role || "");
                setJoiningDate(employee.date_joined?.split("T")[0] || "");
                setPersonalDetail({
                    ssn_number: employee.personal_detail?.ssn_number || "",
                    home_phone: employee.personal_detail?.home_phone || "",
                    personal_number: employee.personal_detail?.personal_number || "",
                    emergency_contact: employee.personal_detail?.emergency_contact || "",
                });
                setAddressDetail({
                    current_street_address_1: employee.address_detail?.current_street_address_1 || "",
                    current_street_address_2: employee.address_detail?.current_street_address_2 || "",
                    current_country: employee.address_detail?.current_country || "",
                    current_state: employee.address_detail?.current_state || "",
                    current_city: employee.address_detail?.current_city || "",
                    current_zip_code: employee.address_detail?.current_zip_code || "",
                    permanent_street_address_1: employee.address_detail?.permanent_street_address_1 || "",
                    permanent_street_address_2: employee.address_detail?.permanent_street_address_2 || "",
                    permanent_country: employee.address_detail?.permanent_country || "",
                    permanent_state: employee.address_detail?.permanent_state || "",
                    permanent_city: employee.address_detail?.permanent_city || "",
                    permanent_zip_code: employee.address_detail?.permanent_zip_code || "",
                });
                setBankDetail({
                    account_number: employee.bank_detail?.account_number || "",
                    bank_name: employee.bank_detail?.bank_name || "",
                    routing_code: employee.bank_detail?.routing_code || "",
                    branch_name: employee.bank_detail?.branch_name || "",
                });
                setVisaDetail({
                    passport_number: employee.visa_detail?.passport_number || "",
                    passport_country: employee.visa_detail?.passport_country || "",
                    visa_type: employee.visa_detail?.visa_type || "",
                    visa_start_date: employee.visa_detail?.visa_start_date || "",
                    visa_end_date: employee.visa_detail?.visa_end_date || "",
                    visa_country: employee.visa_detail?.visa_country || "",
                    visa_renewal_date: employee.visa_detail?.visa_renewal_date || "",
                    visa_status: employee.visa_detail?.visa_status || "",
                });
                setEducationList(
                                                ...
                                                <div className='col-3'>
                                                    ...
                                                    <div className='position-relative'>
                                                        <Select
                                                            ...
                                                            value={addressDetail.current_country}
